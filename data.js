...
const CLUES_SETS = {
    ...
    "karla": {
        ...
        clues: [
            ...
            { id: 4, code: "J9W1R5", title: "Pista 4", description: "EL próximo es código está detrás del escudo de tu equipo.", isFinal: false },
            { id: 5, code: "K2X8M4", title: "¡FINAL!", description: "El regalo final está sobretodos nosotros, donde todo ve pasar el tiempo.", isFinal: true }
        ]
    },
    "carolina": {
    ...
    "olea": {
        ...
        isGPS: true,
        initialClue: "Empieza la búsqueda, tu siguiente pista está en la puerta que aparece y desaparece cada mayo.",
